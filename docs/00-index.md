...
Status: living. Design docs plus the shipped surface; each doc carries its own status. Read in order.
...
| 15 | [landscape](15-landscape.md) | 80-tool survey (2026-09-06), the gaps ranked, M12 Reach proposal |
