...
The views live at the top of the sidebar, in four groups: **Observe** (Fleet, Timeline), **Work** (Board, PRs), **Insight** (Outcomes, Spend, Stats, Search) and **Guard** (Incidents, with a count of unacknowledged ones). Your last view and the selected project are remembered across reloads.
