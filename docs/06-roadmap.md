...
| M6.4 | Signing/notarization (macOS); CI release pipeline | M6.3 | 🟡 2026-08-21 `release.yml` (tauri-action on `v*`) reuses the existing Apple account creds via a var-name mapping (`docs/11`); Windows/Linux bundles TBD |
