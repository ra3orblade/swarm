...
const VIEWS = ["fleet", "board", "timeline", "spend", "stats"];
...
document.addEventListener("click", async (ev) => {
  const t = ev.target.closest("[data-menu],#settings,[data-id],[data-s],#back,[data-view],.chip,[data-tl],[data-days],[data-sdays],[data-release],[data-forcerelease],[data-resrelease]");
  if (!t) return;
