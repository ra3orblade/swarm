...
// Generated here (not committed) so CI always has a frontendDist regardless of .gitignore, and
// drawn from `core/src/art.ts` so it can never fall behind the rest of the marks.
const dist = join(root, "apps/desktop/dist");
mkdirSync(dist, { recursive: true });
Bun.write(join(dist, "index.html"), splashHtml());
